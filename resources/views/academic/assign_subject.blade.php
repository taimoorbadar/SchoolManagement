                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card m-b-200">
                            ...
                            <form class="" action="{{route('assignsubject.store')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class=""><strong> Assign Subject</strong></label>
                                                <select name="grade_id" class="form-control" required>
                                                    <option value="">--Select--</option>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class=""><strong> Teacher Name</strong></label>
